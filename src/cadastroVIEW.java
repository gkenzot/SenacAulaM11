    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        ...
        if (!valorText.isEmpty()) {
            try {
                ...
                // Limpar as caixas de texto após o cadastro
                cadastroNome.setText("");
                cadastroValor.setText("");
            } catch (NumberFormatException e) {
                // Tratar o caso em que o valor não é um número válido
                JOptionPane.showMessageDialog(this, "O valor informado não é válido.", "Erro", JOptionPane.ERROR_MESSAGE);
            }
        } else {
            // Tratar o caso em que o campo de valor está vazio
            JOptionPane.showMessageDialog(this, "O campo de valor não pode estar vazio.", "Erro", JOptionPane.ERROR_MESSAGE);
        }
